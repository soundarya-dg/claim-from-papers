...
# Test the chunker and vector store
def main():

    
    print(f"\n{'-'*80}")
    print(f"Text Chunker and Vector Store Test")
    print(f"{'-'*80}\n")
    ...
    for doc in parsed_docs:
        ...
        all_chunks.extend(chunks)
        print(f"  {doc['title'][:60]}: {len(chunks)} chunks")
    ...
    # Test query
    print(f"\n5. Testing query...")
    test_query = "What is AI-generated text detection?"
